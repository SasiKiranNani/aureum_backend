...
@section('contents')
 <section id="section-hero" class="section-dark no-top no-bottom text-light jarallax relative mh-800" data-video-src="{{ asset('frontend/video/2.mp4') }}">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="hover">
                            <div class="bg-dark-2 relative rounded-1 overflow-hidden hover-bg-color hover-text-light wow scale-in-mask">
                                ...
                                <img src="{{ asset('frontend/images/misc/s3.webp') }}" class="w-100 hover-scale-1-1" alt="">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="hover">
                            <div class="bg-dark-2 relative rounded-1 overflow-hidden hover-bg-color hover-text-light wow scale-in-mask">
                                ...
                                <div class="gradient-edge-bottom h-100"></div>
                                <img src="{{ asset('frontend/images/misc/s4.webp') }}" class="w-100 hover-scale-1-1" alt="">
                                <div class="abs w-100 h-100 start-0 top-0 hover-op-1 radial-gradient-color"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="hover">
                            <div class="bg-dark-2 relative rounded-1 overflow-hidden hover-bg-color hover-text-light wow scale-in-mask">
                                ...
                                <div class="gradient-edge-bottom h-100"></div>
                                <img src="{{ asset('frontend/images/misc/s5.webp') }}" class="w-100 hover-scale-1-1" alt="">
                                <div class="abs w-100 h-100 start-0 top-0 hover-op-1 radial-gradient-color"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="hover">
                            <div class="bg-dark-2 relative rounded-1 overflow-hidden hover-bg-color hover-text-light wow scale-in-mask">
                                ...
                                <div class="gradient-edge-bottom h-100"></div>
                                <img src="{{ asset('frontend/images/misc/s6.webp') }}" class="w-100 hover-scale-1-1" alt="">
                                <div class="abs w-100 h-100 start-0 top-0 hover-op-1 radial-gradient-color"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="hover">
                            <div class="bg-dark-2 relative rounded-1 overflow-hidden hover-bg-color hover-text-light wow scale-in-mask">
                                ...
                                <div class="gradient-edge-bottom h-100"></div>
                                <img src="{{ asset('frontend/images/misc/s7.webp') }}" class="w-100 hover-scale-1-1" alt="">
                                <div class="abs w-100 h-100 start-0 top-0 hover-op-1 radial-gradient-color"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="hover">
                            <div class="bg-dark-2 relative rounded-1 overflow-hidden hover-bg-color hover-text-light wow scale-in-mask">
                                ...
                                <div class="gradient-edge-bottom h-100"></div>
                                <img src="{{ asset('frontend/images/misc/s8.webp') }}" class="w-100 hover-scale-1-1" alt="">
                                <div class="abs w-100 h-100 start-0 top-0 hover-op-1 radial-gradient-color"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center g-5">
                    <div class="col-md-4">
                        <div class="relative w-100 d-inline-block pe-5">
                            ...
                            <img src="{{ asset('frontend/images/misc/s9.webp') }}" class="w-100 rounded-1 wow scale-in-mask" alt="">
                        </div>
                    </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="hover relative rounded-1 overflow-hidden wow fadeIn scale-in-mask">
                            <img src="{{ asset('frontend/images/team/1.webp') }}" class="w-100 hover-scale-1-1" alt="">
                            <div class="abs w-100 h-100 start-0 top-0 hover-op-1 radial-gradient-color"></div>
                            <div class="abs w-100 start-0 bottom-0 z-3">
                    ...
                    <div class="col-lg-4">
                        <div class="hover relative rounded-1 overflow-hidden wow fadeIn scale-in-mask">
                            <img src="{{ asset('frontend/images/team/2.webp') }}" class="w-100 hover-scale-1-1" alt="">
                            <div class="abs w-100 h-100 start-0 top-0 hover-op-1 radial-gradient-color"></div>
                            <div class="abs w-100 start-0 bottom-0 z-3">
                                <div class="bg-blur p-4 m-4 rounded-1 text-light text-center relative z-2">
                    ...
                    <div class="col-lg-4">
                        <div class="hover relative rounded-1 overflow-hidden wow fadeIn scale-in-mask">
                            <img src="{{ asset('frontend/images/team/3.webp') }}" class="w-100 hover-scale-1-1" alt="">
                            <div class="abs w-100 h-100 start-0 top-0 hover-op-1 radial-gradient-color"></div>
                            <div class="abs w-100 start-0 bottom-0 z-3">
                                <div class="bg-blur p-4 m-4 rounded-1 text-light text-center relative z-2">
                            ...
                            <li>
                                    ...
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/1.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/2.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/3.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/4.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                            ...
                            <li>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/5.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                                    <h5 class="mb-0">Leila Zhang</h5>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/6.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/7.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/8.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                            ...
                            <li>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/9.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/10.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/11.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/12.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                            ...
                            <li>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/13.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/14.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/15.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/16.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                            ...
                            <li>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/17.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/18.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="border-white-bottom-op-2 pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/19.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
                                ...
                                <div class="pb-5 mb-5">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('frontend/images/team/20.webp') }}" class="w-100px rounded-1 me-4" alt="">
                                                <div>
        ...
        <section id="section-tickets" class="bg-dark section-dark text-light pt-80 relative jarallax" aria-label="section">
            <img src="{{ asset('frontend/images/background/7.webp') }}" class="jarallax-img" alt="">
            <div class="gradient-edge-top"></div>
            <div class="gradient-edge-bottom"></div>
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-12">
                        <div class="owl-carousel owl-theme owl-3-dots wow mask-right">
                            ...
                            <div class="item">
                                <div class="d-ticket">
                                    <img src="{{ asset('frontend/images/logo.webp') }}" class="w-80px mb-4" alt="">
                                    <img src="{{ asset('frontend/images/misc/barcode.webp') }}" class="w-20 p-2 abs abs-middle end-0 me-2" alt="">
                                    <img src="{{ asset('frontend/images/logo-big-white.webp') }}" class="w-40 abs abs-centered me-4 op-2" alt="">
                                    <h2>Standard</h2>
